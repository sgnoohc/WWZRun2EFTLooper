...
void vvvtree::Init(TTree *tree) {
  ...
  Var_4LepMET_scale1fb_branch = tree->GetBranch("Var_4LepMET_scale1fb");
  if (Var_4LepMET_scale1fb_branch) Var_4LepMET_scale1fb_branch->SetAddress(&Var_4LepMET_scale1fb_);
...
void vvvtree::GetEntry(unsigned int idx) {
  ...
  Var_4LepMET_scale1fb_isLoaded = false;
}
...
void vvvtree::LoadAllBranches() {
  ...
  if (Var_4LepMET_scale1fb_branch != 0) Var_4LepMET_scale1fb();
}
...
const float &vvvtree::Var_4LepMET_scale1fb() {
  if (not Var_4LepMET_scale1fb_isLoaded) {
    if (Var_4LepMET_scale1fb_branch != 0) {
      Var_4LepMET_scale1fb_branch->GetEntry(index);
    } else {
      printf("branch Var_4LepMET_scale1fb_branch does not exist!\n");
      exit(1);
    }
    Var_4LepMET_scale1fb_isLoaded = true;
  }
  return Var_4LepMET_scale1fb_;
}
...
const float &Var_4LepMET_scale1fb() { return vvv.Var_4LepMET_scale1fb(); }
