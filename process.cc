...
//********************************************************************************
    ...
    ana.cutflow.addCut("CutWeight", UNITY, [&]()
                       {
                           ...
                           return vvv.Var_4LepMET_scale1fb() * vvv.Common_genWeight() * weight;
                       } );
    ana.cutflow.addCutToLastActiveCut("CutOtherTightLep", 
                                      [&]()
                                      {
                                          if (not (vvv.Common_lep_tight()[vvv.Var_4LepMET_other_lep_idx_1()])) return false;
                                          if (not (vvv.Common_lep_tight()[vvv.Var_4LepMET_other_lep_idx_0()])) return false;
                                          if (not (vvv.Common_lep_sip3d()[vvv.Var_4LepMET_other_lep_idx_1()] < 4)) return false;
                                          if (not (vvv.Common_lep_sip3d()[vvv.Var_4LepMET_other_lep_idx_0()] < 4)) return false;
                                          return true;
                                      }, UNITY );
    ...
    ana.cutflow.getCut("CutDuplicate");
    ...
    ana.cutflow.addCutToLastActiveCut("CutOffZBV", [&]() { return vvv.Common_nb_medium() == 0; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOffZDR", [&]() { return DRll < 1.6; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOffZST", [&]() { return STLep > 500.; }, UNITY);

    ana.cutflow.getCut("CutOnZ");
    ana.cutflow.addCutToLastActiveCut("CutOnZFJ", [&]() { return vvv.Common_fatjet_p4().size() > 0; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOnZFJDR", [&]() { return DRll < 1.4; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOnZFJST", [&]() { return STLepHad > 1000.; }, UNITY);

    ana.cutflow.getCut("CutOnZ");
    ana.cutflow.addCutToLastActiveCut("CutOnZNoFJ", [&]() { return vvv.Common_fatjet_p4().size() == 0; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOnZNoFJDR", [&]() { return DRll < 1.4; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutOnZNoFJST", [&]() { return STLep > 1000.; }, UNITY);

    ana.cutflow.getCut("CutEMu");
    ana.cutflow.addCutToLastActiveCut("CutEMuBV", [&]() { return vvv.Common_nb_medium() == 0; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutEMuDR", [&]() { return DRll < 2.0; }, UNITY);
    ana.cutflow.addCutToLastActiveCut("CutEMuST", [&]() { return STLep > 400.; }, UNITY);

    ana.cutflow.getCut("CutEMu");
    ana.cutflow.addCutToLastActiveCut("CutEMuBT", [&]() { return vvv.Common_nb_medium() > 0; }, UNITY);

    ana.cutflow.getCut("CutOnZNoFJ");
    ana.cutflow.addCutToLastActiveCut("CutOnZNoFJDRCR", [&]() { return DRll > 1.4; }, UNITY);

    ana.cutflow.getCut("CutOnZFJ");
    ana.cutflow.addCutToLastActiveCut("CutOnZFJDRCR", [&]() { return DRll > 1.4; }, UNITY);
    ...
    ana.histograms.addHistogram("STLepFit", {400.0, 500.0, 1000.0, 1500.0, 2000.0, 2500.0, 3000.0}, [&]() { return STLep; } );
    ana.histograms.addHistogram("STLepHadFit", {400.0, 500.0, 1000.0, 1500.0, 2000.0, 2500.0, 3000.0}, [&]() { return STLepHad; } );
    ana.histograms.addHistogram("STLep", 180, 0., 3000., [&]() { return STLep; } );
    ana.histograms.addHistogram("STLepHad", 180, 0., 3000., [&]() { return STLepHad; } );
    ana.histograms.addHistogram("nb", 5, 0, 5, [&]() { return vvv.Common_nb_medium(); } );
